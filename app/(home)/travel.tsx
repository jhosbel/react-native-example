    ...
    <View className="bg-[#282F62] h-full justify-center">
      <View className="w-full h-[642] bg-[#343B71]">
        ...
        <View className="gap-2">
          <Text className="text-center text-[12px] text-[#7177AB]">Finalizados</Text>
          <View className="w-[370px] h-[127px] bg-[#282F62] rounded-[5px] p-2 self-center shadow-2xl">
            ...
            <Text className="text-white text-[12px]">Envigado - Plaza Viva Envigado</Text>
            <Text className="text-white text-[12px]">Itagui - Barrio La Union</Text>
          </View>
